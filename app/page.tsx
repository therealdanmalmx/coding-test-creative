...
export default function Home() {
  ...
  return (
    <main className='w-full h-dvh md:py-24 bg-gradient-to-b md:bg-gradient-to-r from-gray-500 to-gray-950'>
      <div className='h-full py-14 md:py-0 md:flex md:flex-row items-center justify-center space-y-12 md:space-x-10 md:space-y-0'>
